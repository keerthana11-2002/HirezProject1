    ...
    <main className="xl:ml-96 p-4 flex flex-col gap-6 sm:gap-8 md:gap-10 lg:gap-16 py-8 sm:py-12 lg:py-20 ">
      <section className="text-center mx-auto ">
        <h1 className="flex flex-col items-center justify-center gradient-title font-bold text-4xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-8xl tracking-tighter py-4">
          ...
          <span className="mt-2 md:mt-3 xl:mb-6 lg:mt-4 xl:mt-5 mb-3 ">
            land your dream job
          </span>
      ...
      <div className="flex flex- sm:flex-row gap-3 sm:gap-4 md:gap-6 lg:gap-8  justify-center mt-4">
        <Link to={"/jobs"}>
          <Button
            variant="blue"
            size="xl"
            className=" items-center w-36 h-20 lg:text-2xl "
          >
            Find Jobs
          </Button>
        </Link>
      ...
      <Accordion
        type="multiple"
        className="w-full text-sm md:text-base lg:text-lg xl:text-xl"
      >
        {faqs.map((faq, index) => (
